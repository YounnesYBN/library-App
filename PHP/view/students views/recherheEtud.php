<?php
session_start();
if(isset($_SESSION["serchepass"])){
        if($_SESSION['serchepass']==false){
...
<body>
        <div id="parent">
                <select name="select" id="select">
                        ...
                        <option value="prenom" name="prenom">prenom</option>
                        <option value="class" name="class">class</option>
                        <option value="adresse" name="adresse">adresse</option>
                </select>
        ...
        <div id="table-con">
                        <table>
                                ...
                                <thead>
                                <tr><th>code</th><th>nom</th><th>prenom</th><th>class</th><th>adresse</th></tr>"
                                </thead>
                                <tbody>
...
<script >
        $("document").ready(function(){
                ...
                $("#enter").click(function(){
                        ...
                        $.ajax({
                                type:"GET",
                                url:"../../controle/students handler/searchEhandler.php",
